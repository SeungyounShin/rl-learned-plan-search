...
#
# python -m examples.data_preprocess.preprocess_search_r1_dataset_w_think --hf_repo_id PeterJinGo/nq_hotpotqa_train --local_dir ~/data/searchR1_processed_direct
# 
